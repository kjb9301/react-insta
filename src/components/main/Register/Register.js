...
const Register = ({regInfo,handleChange,handleRegClick}) => {
  return (
    <div className="reg-form">
      ...
      <input className="reg-btn" type="button" value="Register" onClick={() => handleRegClick(regInfo.nickname,regInfo.email,regInfo.pwd)}/>
    </div>
  );
};
